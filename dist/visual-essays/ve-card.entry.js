import { r as registerInstance, h as h$1, g as getElement } from './index-d76dec7f.js';
import { g as getManifest, t as thumbnail, l as label } from './utils-7ad1d5d5.js';
...
var o$3 = (t3) => new s(typeof t3 == "string" ? t3 : t3 + "", e$2);
var r = (t3, ...n5) => {
...
var s2;
var e2$1 = window.trustedTypes;
var r2 = e2$1 ? e2$1.emptyScript : "";
...
var l$1 = { attribute: true, type: String, converter: o2$1, reflect: false, hasChanged: n2$1 };
var a = class extends HTMLElement {
  ...
  requestUpdate(t3, i3, s5) {
    let e4 = true;
    t3 !== void 0 && (((s5 = s5 || this.constructor.getPropertyOptions(t3)).hasChanged || n2$1)(this[t3], i3) ? (this._$AL.has(t3) || this._$AL.set(t3, i3), s5.reflect === true && this._$Ei !== t3 && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(t3, s5))) : e4 = false), !this.isUpdatePending && e4 && (this._$Ep = this._$E_());
  }
  async _$E_() {
...
var e3$2 = `lit$${(Math.random() + "").slice(9)}$`;
var o3 = "?" + e3$2;
var n3 = `<${o3}>`;
var l2 = document;
...
var C = (t3, i3) => {
  ...
  for (let i4 = 0; i4 < o5; i4++) {
    ...
    r4 += d2 === c ? s5 + n3 : p2 >= 0 ? (l4.push(o6), s5.slice(0, p2) + "$lit$" + s5.slice(p2) + e3$2 + y2) : s5 + e3$2 + (p2 === -2 ? (l4.push(void 0), i4) : y2);
  }
      ...
      if (l4.nodeType === 1) {
        if (l4.hasAttributes()) {
          ...
          for (const i3 of l4.getAttributeNames())
            if (i3.endsWith("$lit$") || i3.startsWith(e3$2)) {
              const s6 = a3[d2++];
              if (t4.push(i3), s6 !== void 0) {
                const t5 = l4.getAttribute(s6.toLowerCase() + "$lit$").split(e3$2), i4 = /([.?@])?(.*)/.exec(s6);
        ...
        if (g.test(l4.tagName)) {
          const t4 = l4.textContent.split(e3$2), s6 = t4.length - 1;
          if (s6 > 0) {
        ...
        if (l4.data === o3)
          ...
          let t4 = -1;
          for (; (t4 = l4.data.indexOf(e3$2, t4 + 1)) !== -1; )
            c2.push({ type: 7, index: r4 }), t4 += e3$2.length - 1;
        }
      r4++;
    }
  }
...
var R = { L: "$lit$", P: e3$2, V: o3, I: 1, N: C, R: V, j: u, D: P, H: N, F: S2, O: H, W: I, B: M, Z: L };
...
var o$1 = ({ finisher: e4, descriptor: t2 }) => (o2, n3) => {
  var r;
  if (n3 === void 0) {
...
function e2(e4) {
  return o$1({ descriptor: (r) => ({ async get() {
    var r2;
...
var n2;
var e3$1 = ((n2 = window.HTMLSlotElement) === null || n2 === void 0 ? void 0 : n2.prototype.assignedElements) != null ? (o2, n3) => o2.assignedElements(n3) : (o2, n3) => o2.assignedNodes(n3).filter((o3) => o3.nodeType === Node.ELEMENT_NODE);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
setBasePath('https://visual-essays.github.io/wc');
const Card = class {
  constructor(hostRef) {
  ...
  render() {
    return [
      h$1("sl-card", { class: "card-overview" }, h$1("img", { slot: "image", src: thumbnail(this._manifest), alt: label(this._manifest) }), h$1("div", { class: "label", innerHTML: this.label }), h$1("sl-icon", { name: "envelope" }), this.description && h$1("div", { class: "description", innerHTML: this.description }))
    ];
  }
