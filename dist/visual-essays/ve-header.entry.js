  ...
  render() {
    return [
      h("section", { class: "ve-header" }, h("div", { class: "title-panel" }, h("sl-icon", { id: "info-icon", name: "info-circle-fill", onClick: this._showInfoPopup.bind(this), title: "Image info" }), this.searchDomain
        ? h("div", { id: "search-box" }, h("ve-search", { filters: this.searchFilters, icon: true, animationLength: "2" }), h("sl-tooltip", { content: "Click to search the site" }, h("sl-icon", { id: "search-icon", name: "search", onClick: this._toggleSearchBox.bind(this) })))
