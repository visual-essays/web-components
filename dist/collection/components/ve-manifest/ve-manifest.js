...
export class ManifestViewer {
  ...
  render_condensed() {
    return this._images.map(item => this.parseManifest(item)).map(parsed => h("div", { class: "manifest condensed" },
      parsed.thumbnail ? h("img", { class: "thumbnail", src: parsed.thumbnail }) : null,
      h("div", { class: "lbl", style: { marginBottom: '12px;' } }, parsed.sourceUrl
        ? h("a", { href: parsed.sourceUrl, innerHTML: parsed.label })
        : parsed.label),
      parsed.summary
        ? h("div", { class: "summary" },
          h("span", { class: "value" }, parsed.summary))
        : null,
      parsed.requiredStatement
        ? h("div", null,
          h("span", { class: "value", innerHTML: parsed.requiredStatement.value }))
        : null,
      parsed.rights
        ? h("div", { class: "rights" },
          h("a", { class: "value", href: parsed.rights, innerHTML: this.licenseBadge(parsed) }))
        : null,
      parsed.provider
        ? h("div", { class: "provider" }, parsed.provider.length == 1
          ? h("div", { style: { display: 'flex', alignItems: 'center' } },
            parsed.provider[0].logo
              ...
              : null,
            h("a", { class: "value", href: parsed.provider[0].href, innerHTML: parsed.provider[0].label }))
          : h("ul", null, parsed.provider.map((provider) => h("li", null,
            provider.logo
              ? h("img", { class: "logo", src: provider.logo.src, height: 20 })
              : null,
            h("a", { class: "value", href: provider.href, innerHTML: provider.label })))))
        : null,
      parsed.imageData.width
        ? h("div", null,
          h("span", { class: "label" }, "Dimensions"),
          " ",
          h("span", { innerHTML: parsed.imageData.width.toLocaleString() }),
          " x ",
          h("span", { innerHTML: parsed.imageData.height.toLocaleString() }))
        : null,
      parsed.depicts
        ? h("div", null,
          h("span", { class: "label" }, "Depicts"),
          h("ul", null, parsed.depicts.map(depicts => h("li", { innerHTML: depicts }))))
        : null,
      h("a", { draggable: true, onDragStart: this.onManifestIconDrag.bind(this), href: parsed.id },
        h("img", { src: "https://avatars.githubusercontent.com/u/5812589?v=3&s=24", alt: "IIIF Manifest" }))));
  }
  render_full() {
    return this._images.map(item => this.parseManifest(item)).map(parsed => h("div", { class: "manifest" },
      h("div", { class: "manifest-id" },
        h("span", { class: "label" }, "id"),
        h("a", { class: "value", href: parsed.id, innerHTML: parsed.id })),
      h("div", { class: "manifest-label" },
        h("span", { class: "label" }, "label"),
        h("span", { class: "value" }, parsed.label)),
      parsed.summary
        ? h("div", { class: "summary" },
      ...
      parsed.metadata
        ? h("div", { class: "metadata" },
          h("span", { class: "label" }, "metadata"),
          h("ul", null, parsed.metadata.map((item) => h("li", null,
      ...
      parsed.navDate
        ? h("div", { class: "navDate" },
          h("span", { class: "label" }, "navDate"),
          h("span", { class: "value" }, parsed.navDate))
        : null,
      parsed.provider
        ...
        : null,
      parsed.homepage
        ? h("div", { class: "homepage" },
          h("span", { class: "label" }, "homepage"),
          h("a", { class: "value", href: parsed.homepage.href, innerHTML: parsed.homepage.label }))
        : null,
      parsed.seeAlso
        ? h("div", { class: "seeAlso" },
          h("span", { class: "label" }, "seeAlso"),
          h("a", { class: "value", href: parsed.seeAlso[0].href, innerHTML: parsed.seeAlso[0].label }))
        : null,
      parsed.logo
        ? h("div", { class: "logo" },
          h("span", { class: "label" }, "logo"),
          h("a", { class: "value", href: parsed.logo[0].src, innerHTML: parsed.logo[0].src }))
        : null,
      parsed.rights
        ? h("div", { class: "rights" },
          h("span", { class: "label" }, "rights"),
          h("a", { class: "value", href: parsed.rights, innerHTML: parsed.rights }))
        : null,
      parsed.requiredStatement
        ? h("div", { class: "requiredStatement" },
          h("span", { class: "label" }, "requiredStatement"),
          h("ul", null,
            h("li", null,
              ...
              h("span", { class: "value", innerHTML: parsed.requiredStatement.value }))))
        : null,
      h("div", { class: "imageData" },
        h("div", null,
          h("span", { class: "label" }, "image"),
          h("a", { class: "value", href: parsed.imageData.id, innerHTML: parsed.imageData.id })),
        h("div", null,
          h("span", { class: "label" }, "format"),
          h("span", { class: "value", innerHTML: parsed.imageData.format })),
        h("div", null,
          h("span", { class: "label" }, "width"),
          h("span", { class: "value", innerHTML: parsed.imageData.width })),
        h("div", null,
          h("span", { class: "label" }, "height"),
          h("span", { class: "value", innerHTML: parsed.imageData.height }))),
      ",",
      parsed.thumbnail
        ? h("div", { class: "thumbnail" },
          h("span", { class: "label" }, "thumbnail"),
          h("a", { class: "value", href: parsed.thumbnail, innerHTML: parsed.thumbnail }))
        : null,
      parsed.service
        ? h("div", { class: "service" },
          h("span", { class: "label" }, "service"),
          h("a", { class: "value", href: parsed.service, innerHTML: parsed.service }))
        : null));
  }
  render() {
    return this._images
  ...
  static get is() { return "ve-manifest"; }
