...
import { g as getManifest, i as imageInfo } from './utils.js';
...
const ManifestViewer = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return veManifestCss; }
}, [1, "ve-manifest", {
    "src": [1],
    "images": [1537],
    "depicts": [1040],
...
function defineCustomElement() {
  ...
  const components = ["ve-manifest"];
  components.forEach(tagName => { switch (tagName) {
    case "ve-manifest":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ManifestViewer);
      }
      break;
  } });
}

export { ManifestViewer as M, defineCustomElement as d };
