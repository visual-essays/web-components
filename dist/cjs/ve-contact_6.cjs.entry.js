...
const chunk_RP2CLKS2 = require('./chunk.RP2CLKS2-a7f5b409.js');
const chunk_COG46KYT = require('./chunk.COG46KYT-c6ea5d41.js');
...
var alert_styles_default = chunk_GP3HCHHG.r`
...
var SlAlert = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    this.hasSlotController = new chunk_3IYPB6RR.HasSlotController(this, "icon", "suffix");
  ...
  async handleOpenChange() {
    if (this.open) {
      ...
      await chunk_KO3SJXDW.stopAnimations(this.base);
      this.base.hidden = false;
      const { keyframes, options } = chunk_KO3SJXDW.getAnimation(this, "alert.show", { dir: this.localize.dir() });
      await chunk_KO3SJXDW.animateTo(this.base, keyframes, options);
      chunk_GP3HCHHG.emit(this, "sl-after-show");
    } else {
      chunk_GP3HCHHG.emit(this, "sl-hide");
      clearTimeout(this.autoHideTimeout);
      await chunk_KO3SJXDW.stopAnimations(this.base);
      const { keyframes, options } = chunk_KO3SJXDW.getAnimation(this, "alert.hide", { dir: this.localize.dir() });
      await chunk_KO3SJXDW.animateTo(this.base, keyframes, options);
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.watch("duration")
], SlAlert.prototype, "handleDurationChange", 1);
SlAlert = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-alert")
], SlAlert);
chunk_KO3SJXDW.setDefaultAnimation("alert.show", {
  keyframes: [
...
chunk_KO3SJXDW.setDefaultAnimation("alert.hide", {
  keyframes: [
    { opacity: 1, transform: "scale(1)" },
    { opacity: 0, transform: "scale(0.8)" }
  ],
...
var form_control_styles_default = chunk_GP3HCHHG.r`
...
var input_styles_default = chunk_GP3HCHHG.r`
  ${chunk_GP3HCHHG.component_styles_default}
...
var l = chunk_GP3HCHHG.e$1(class extends chunk_GP3HCHHG.i {
  constructor(r2) {
    if (super(r2), r2.type !== chunk_GP3HCHHG.t.PROPERTY && r2.type !== chunk_GP3HCHHG.t.ATTRIBUTE && r2.type !== chunk_GP3HCHHG.t.BOOLEAN_ATTRIBUTE)
  ...
  update(i3, [t2]) {
    if (t2 === chunk_GP3HCHHG.b || t2 === chunk_GP3HCHHG.w)
      return t2;
    const o = i3.element, l2 = i3.name;
    if (i3.type === chunk_GP3HCHHG.t.PROPERTY) {
      if (t2 === o[l2])
        return chunk_GP3HCHHG.b;
    } else if (i3.type === chunk_GP3HCHHG.t.BOOLEAN_ATTRIBUTE) {
      if (!!t2 === o.hasAttribute(l2))
        return chunk_GP3HCHHG.b;
    } else if (i3.type === chunk_GP3HCHHG.t.ATTRIBUTE && o.getAttribute(l2) === t2 + "")
      return chunk_GP3HCHHG.b;
    return s(i3), t2;
  }
});
...
var SlInput = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    this.formSubmitController = new chunk_RP2CLKS2.FormSubmitController(this);
    this.hasSlotController = new chunk_3IYPB6RR.HasSlotController(this, "help-text", "label");
    this.localize = new chunk_KO3SJXDW.LocalizeController2(this);
    this.hasFocus = false;
  ...
  setRangeText(replacement, start, end, selectMode = "preserve") {
    ...
    if (this.value !== this.input.value) {
      this.value = this.input.value;
      chunk_GP3HCHHG.emit(this, "sl-input");
      chunk_GP3HCHHG.emit(this, "sl-change");
    }
  }
  reportValidity() {
  ...
  handleClearClick(event) {
    this.value = "";
    chunk_GP3HCHHG.emit(this, "sl-clear");
    chunk_GP3HCHHG.emit(this, "sl-input");
    chunk_GP3HCHHG.emit(this, "sl-change");
    this.input.focus();
      ...
      "input--invalid": this.invalid
          ...
          >
            ...
            <input
              ...
              placeholder=${chunk_GP3HCHHG.l(this.placeholder)}
              minlength=${chunk_GP3HCHHG.l(this.minlength)}
              maxlength=${chunk_GP3HCHHG.l(this.maxlength)}
              min=${chunk_GP3HCHHG.l(this.min)}
              max=${chunk_GP3HCHHG.l(this.max)}
              step=${chunk_GP3HCHHG.l(this.step)}
              .value=${l(this.value)}
              autocapitalize=${chunk_GP3HCHHG.l(this.autocapitalize)}
              autocomplete=${chunk_GP3HCHHG.l(this.autocomplete)}
              autocorrect=${chunk_GP3HCHHG.l(this.autocorrect)}
              ?autofocus=${this.autofocus}
              spellcheck=${chunk_GP3HCHHG.l(this.spellcheck)}
              pattern=${chunk_GP3HCHHG.l(this.pattern)}
              enterkeyhint=${chunk_GP3HCHHG.l(this.enterkeyhint)}
              inputmode=${chunk_GP3HCHHG.l(this.inputmode)}
            ...
            ${hasClearIcon ? chunk_GP3HCHHG.$`
                ...
                ` : ""}
            ${this.togglePassword && !this.disabled ? chunk_GP3HCHHG.$`
                  <button
                    ...
                    tabindex="-1"
                  >
                    ${this.isPasswordVisible ? chunk_GP3HCHHG.$`
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".input__control")
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.e({ attribute: "help-text" })
], SlInput.prototype, "helpText", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.e({ type: Boolean })
], SlInput.prototype, "clearable", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.e({ attribute: "toggle-password", type: Boolean })
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.watch("disabled", { waitUntilFirstUpdate: true })
], SlInput.prototype, "handleDisabledChange", 1);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.watch("value", { waitUntilFirstUpdate: true })
], SlInput.prototype, "handleValueChange", 1);
SlInput = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-input")
], SlInput);

// src/components/textarea/textarea.styles.ts
var textarea_styles_default = chunk_GP3HCHHG.r`
  ${chunk_GP3HCHHG.component_styles_default}
  ${form_control_styles_default}
...
var SlTextarea = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    this.formSubmitController = new chunk_RP2CLKS2.FormSubmitController(this);
    this.hasSlotController = new chunk_3IYPB6RR.HasSlotController(this, "help-text", "label");
      ...
      "textarea--resize-auto": this.resize === "auto"
          ...
          >
            <textarea
              ...
              ?required=${this.required}
              placeholder=${chunk_GP3HCHHG.l(this.placeholder)}
              rows=${chunk_GP3HCHHG.l(this.rows)}
              minlength=${chunk_GP3HCHHG.l(this.minlength)}
              maxlength=${chunk_GP3HCHHG.l(this.maxlength)}
              autocapitalize=${chunk_GP3HCHHG.l(this.autocapitalize)}
              autocorrect=${chunk_GP3HCHHG.l(this.autocorrect)}
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".textarea__control")
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.watch("rows", { waitUntilFirstUpdate: true })
], SlTextarea.prototype, "handleRowsChange", 1);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.watch("value", { waitUntilFirstUpdate: true })
], SlTextarea.prototype, "handleValueChange", 1);
SlTextarea = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-textarea")
], SlTextarea);
...
var dropdown_styles_default = chunk_GP3HCHHG.r`
  ${chunk_GP3HCHHG.component_styles_default}
...
var SlDropdown = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    this.localize = new chunk_KO3SJXDW.LocalizeController2(this);
    this.open = false;
  ...
  handleMenuItemActivate(event) {
    ...
    chunk_RP2CLKS2.scrollIntoView(item, this.panel);
  }
  ...
  updateAccessibleTrigger() {
    ...
    const accessibleTrigger = assignedElements.find((el) => chunk_RP2CLKS2.getTabbableBoundary(el).start);
    let target;
  ...
  async handleOpenChange() {
    ...
    if (this.open) {
      chunk_GP3HCHHG.emit(this, "sl-show");
      this.addOpenListeners();
      await chunk_KO3SJXDW.stopAnimations(this);
      this.startPositioner();
      this.panel.hidden = false;
      const { keyframes, options } = chunk_KO3SJXDW.getAnimation(this, "dropdown.show", { dir: this.localize.dir() });
      await chunk_KO3SJXDW.animateTo(this.panel, keyframes, options);
      chunk_GP3HCHHG.emit(this, "sl-after-show");
    } else {
      chunk_GP3HCHHG.emit(this, "sl-hide");
      this.removeOpenListeners();
      await chunk_KO3SJXDW.stopAnimations(this);
      const { keyframes, options } = chunk_KO3SJXDW.getAnimation(this, "dropdown.hide", { dir: this.localize.dir() });
      await chunk_KO3SJXDW.animateTo(this.panel, keyframes, options);
  ...
  startPositioner() {
    this.stopPositioner();
    this.updatePositioner();
    this.positionerCleanup = chunk_COG46KYT.N(this.trigger, this.positioner, this.updatePositioner.bind(this));
  }
  updatePositioner() {
    if (!this.open || !this.trigger || !this.positioner) {
      return;
    }
    chunk_COG46KYT.z(this.trigger, this.positioner, {
      placement: this.placement,
      middleware: [
        chunk_COG46KYT.T({ mainAxis: this.distance, crossAxis: this.skidding }),
        chunk_COG46KYT.b(),
        chunk_COG46KYT.D(),
        chunk_COG46KYT.k({
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".dropdown__trigger")
], SlDropdown.prototype, "trigger", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".dropdown__panel")
], SlDropdown.prototype, "panel", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".dropdown__positioner")
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.e({ attribute: "stay-open-on-select", type: Boolean, reflect: true })
], SlDropdown.prototype, "stayOpenOnSelect", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.e({ attribute: false })
...
SlDropdown = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-dropdown")
], SlDropdown);
chunk_KO3SJXDW.setDefaultAnimation("dropdown.show", {
  keyframes: [
...
chunk_KO3SJXDW.setDefaultAnimation("dropdown.hide", {
  keyframes: [
    { opacity: 1, transform: "scale(1)" },
    { opacity: 0, transform: "scale(0.9)" }
  ],
...
var menu_styles_default = chunk_GP3HCHHG.r`
  ${chunk_GP3HCHHG.component_styles_default}
...
var SlMenu = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
  ...
  typeToSelect(event) {
    ...
    if (!chunk_KO3SJXDW.hasFocusVisible) {
    ...
    for (const item of items) {
      ...
      const label = chunk_3IYPB6RR.getTextContent(slot).toLowerCase().trim();
  ...
  handleClick(event) {
    ...
    if ((item == null ? void 0 : item.disabled) === false) {
      chunk_GP3HCHHG.emit(this, "sl-select", { detail: { item } });
    }
  }
  handleKeyUp() {
    if (!chunk_KO3SJXDW.hasFocusVisible) {
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".menu")
], SlMenu.prototype, "menu", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2("slot")
], SlMenu.prototype, "defaultSlot", 2);
SlMenu = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-menu")
], SlMenu);
...
const Header = class {
  ...
  _manifestChanged(newValue, oldValue) {
    if (newValue !== oldValue)
      this._imageInfo = utils.imageInfo(this._manifest);
  }
  async _imageInfoChanged(imageInfo, priorValue) {
    if (imageInfo !== priorValue) {
      this._imgUrl = imageInfo.service
        ...
        : await utils.imageDataUrl(imageInfo.id, this.imageOptions.region, { width: this.el.clientWidth, height: this.height });
    }
  }
  ...
  connectedCallback() {
    ...
    this.imageOptions = utils.parseImageOptions(this.options);
  ...
  componentDidLoad() {
    ...
    utils.getManifest(this.background).then(manifest => this._manifest = manifest);
  }
  htmlToElem(html) {
  ...
  render() {
    return [
      index.h("section", { class: "ve-header" }, index.h("div", { class: "title-panel" }, index.h("sl-icon", { id: "info-icon", name: "info-circle-fill", onClick: this._showInfoPopup.bind(this), title: "Image info" }), this.searchDomain
        ? index.h("div", { id: "search-box" }, index.h("ve-search", { filters: this.searchFilters, icon: true }), index.h("sl-tooltip", { content: "Click to search the site" }, index.h("sl-icon", { id: "search-icon", name: "search", onClick: this._toggleSearchBox.bind(this) })))
        : null, this.navItems.length > 0 &&
        index.h("nav", null, index.h("sl-dropdown", null, index.h("sl-button", { id: "menu-toggle", slot: "trigger", variant: "default", size: "medium", circle: true }, index.h("sl-icon", { name: "three-dots-vertical", label: "Navigation Menu" })), index.h("sl-menu", null, this.navItems.map((item) => index.h("sl-menu-item", { onClick: this.menuItemSelected.bind(this, item) }, index.h("sl-icon", { slot: "prefix", name: this.navIcon(item), label: item.label }), item.label))))), index.h("a", { href: "/" }, index.h("div", { class: "title" }, this.label)), index.h("div", { class: "subtitle" }, this.subtitle), index.h("div", { id: "image-info-popup" }))),
      index.h("ve-contact", { contact: this.contact })
    ];
  }
  get el() { return index.getElement(this); }
...
var badge_styles_default = chunk_GP3HCHHG.r`
  ${chunk_GP3HCHHG.component_styles_default}
...
var SlBadge = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    this.variant = "primary";
    this.pill = false;
...
SlBadge = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-badge")
], SlBadge);

// src/components/drawer/drawer.styles.ts
var drawer_styles_default = chunk_GP3HCHHG.r`
  ${chunk_GP3HCHHG.component_styles_default}
...
var SlDrawer = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    this.hasSlotController = new chunk_3IYPB6RR.HasSlotController(this, "footer");
    this.localize = new chunk_KO3SJXDW.LocalizeController2(this);
    this.open = false;
    this.label = "";
    this.placement = "end";
  ...
  connectedCallback() {
    super.connectedCallback();
    this.modal = new chunk_RP2CLKS2.Modal(this);
  }
  firstUpdated() {
    this.drawer.hidden = !this.open;
    if (this.open && !this.contained) {
      this.modal.activate();
      chunk_RP2CLKS2.lockBodyScrolling(this);
    }
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    chunk_RP2CLKS2.unlockBodyScrolling(this);
  }
  async show() {
    if (this.open) {
      return void 0;
  ...
  requestClose(source) {
    const slRequestClose = chunk_GP3HCHHG.emit(this, "sl-request-close", {
      cancelable: true,
      detail: { source }
    });
    if (slRequestClose.defaultPrevented) {
      const animation = chunk_KO3SJXDW.getAnimation(this, "drawer.denyClose", { dir: this.localize.dir() });
      chunk_KO3SJXDW.animateTo(this.panel, animation.keyframes, animation.options);
      return;
    }
    this.hide();
  }
  ...
  async handleOpenChange() {
    if (this.open) {
      ...
      await Promise.all([chunk_KO3SJXDW.stopAnimations(this.drawer), chunk_KO3SJXDW.stopAnimations(this.overlay)]);
      this.drawer.hidden = false;
      requestAnimationFrame(() => {
        const slInitialFocus = chunk_GP3HCHHG.emit(this, "sl-initial-focus", { cancelable: true });
      ...
      const panelAnimation = chunk_KO3SJXDW.getAnimation(this, `drawer.show${uppercaseFirstLetter(this.placement)}`, {
        dir: this.localize.dir()
      });
      const overlayAnimation = chunk_KO3SJXDW.getAnimation(this, "drawer.overlay.show", { dir: this.localize.dir() });
      await Promise.all([
        chunk_KO3SJXDW.animateTo(this.panel, panelAnimation.keyframes, panelAnimation.options),
        chunk_KO3SJXDW.animateTo(this.overlay, overlayAnimation.keyframes, overlayAnimation.options)
      ]);
      chunk_GP3HCHHG.emit(this, "sl-after-show");
    } else {
      chunk_GP3HCHHG.emit(this, "sl-hide");
      ...
      chunk_RP2CLKS2.unlockBodyScrolling(this);
      await Promise.all([chunk_KO3SJXDW.stopAnimations(this.drawer), chunk_KO3SJXDW.stopAnimations(this.overlay)]);
      const panelAnimation = chunk_KO3SJXDW.getAnimation(this, `drawer.hide${uppercaseFirstLetter(this.placement)}`, {
        dir: this.localize.dir()
      });
      const overlayAnimation = chunk_KO3SJXDW.getAnimation(this, "drawer.overlay.hide", { dir: this.localize.dir() });
      await Promise.all([
        chunk_KO3SJXDW.animateTo(this.panel, panelAnimation.keyframes, panelAnimation.options),
        chunk_KO3SJXDW.animateTo(this.overlay, overlayAnimation.keyframes, overlayAnimation.options)
      ]);
    ...
    return chunk_GP3HCHHG.$`
      ...
      >
        ...
        <div
          ...
          aria-modal="true"
          aria-hidden=${this.open ? "false" : "true"}
          aria-label=${chunk_GP3HCHHG.l(this.noHeader ? this.label : void 0)}
          aria-labelledby=${chunk_GP3HCHHG.l(!this.noHeader ? "title" : void 0)}
          tabindex="0"
        >
          ${!this.noHeader ? chunk_GP3HCHHG.$`
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".drawer")
], SlDrawer.prototype, "drawer", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".drawer__panel")
], SlDrawer.prototype, "panel", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".drawer__overlay")
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.e({ attribute: "no-header", type: Boolean, reflect: true })
], SlDrawer.prototype, "noHeader", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.watch("open", { waitUntilFirstUpdate: true })
], SlDrawer.prototype, "handleOpenChange", 1);
SlDrawer = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-drawer")
], SlDrawer);
chunk_KO3SJXDW.setDefaultAnimation("drawer.showTop", {
  keyframes: [
...
chunk_KO3SJXDW.setDefaultAnimation("drawer.hideTop", {
  keyframes: [
    { opacity: 1, transform: "translateY(0)" },
    { opacity: 0, transform: "translateY(-100%)" }
  ],
...
chunk_KO3SJXDW.setDefaultAnimation("drawer.showEnd", {
  keyframes: [
...
chunk_KO3SJXDW.setDefaultAnimation("drawer.hideEnd", {
  keyframes: [
    { opacity: 1, transform: "translateX(0)" },
    { opacity: 0, transform: "translateX(100%)" }
  ],
...
chunk_KO3SJXDW.setDefaultAnimation("drawer.showBottom", {
  keyframes: [
    { opacity: 0, transform: "translateY(100%)" },
    { opacity: 1, transform: "translateY(0)" }
  ],
...
chunk_KO3SJXDW.setDefaultAnimation("drawer.hideBottom", {
  keyframes: [
    { opacity: 1, transform: "translateY(0)" },
    { opacity: 0, transform: "translateY(100%)" }
  ],
...
chunk_KO3SJXDW.setDefaultAnimation("drawer.showStart", {
  keyframes: [
    { opacity: 0, transform: "translateX(-100%)" },
    { opacity: 1, transform: "translateX(0)" }
  ],
...
chunk_KO3SJXDW.setDefaultAnimation("drawer.hideStart", {
  keyframes: [
    { opacity: 1, transform: "translateX(0)" },
    { opacity: 0, transform: "translateX(-100%)" }
  ],
...
chunk_KO3SJXDW.setDefaultAnimation("drawer.denyClose", {
  keyframes: [{ transform: "scale(1)" }, { transform: "scale(1.01)" }, { transform: "scale(1)" }],
  options: { duration: 250 }
});
chunk_KO3SJXDW.setDefaultAnimation("drawer.overlay.show", {
  keyframes: [{ opacity: 0 }, { opacity: 1 }],
  options: { duration: 250 }
});
chunk_KO3SJXDW.setDefaultAnimation("drawer.overlay.hide", {
  keyframes: [{ opacity: 1 }, { opacity: 0 }],
  options: { duration: 250 }
});

// src/components/image-comparer/image-comparer.styles.ts
var image_comparer_styles_default = chunk_GP3HCHHG.r`
  ${chunk_GP3HCHHG.component_styles_default}
  ...
  .image-comparer__handle${chunk_KO3SJXDW.focusVisibleSelector} {
    outline: var(--sl-focus-ring);
    outline-offset: var(--sl-focus-ring-offset);
  }
`;
...
var i2 = chunk_GP3HCHHG.e$1(class extends chunk_GP3HCHHG.i {
  constructor(t2) {
    var e2;
    if (super(t2), t2.type !== chunk_GP3HCHHG.t.ATTRIBUTE || t2.name !== "style" || ((e2 = t2.strings) === null || e2 === void 0 ? void 0 : e2.length) > 2)
...
var SlImageComparer = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    this.position = 50;
  }
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".image-comparer")
], SlImageComparer.prototype, "base", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".image-comparer__handle")
], SlImageComparer.prototype, "handle", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.e({ type: Number, reflect: true })
], SlImageComparer.prototype, "position", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.watch("position", { waitUntilFirstUpdate: true })
], SlImageComparer.prototype, "handlePositionChange", 1);
SlImageComparer = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-image-comparer")
], SlImageComparer);
...
const ImageViewer = class {
  ...
  async zoomto(arg) {
    ...
    if (!found)
      return;
    let imgIdx = found[1] ? lodash.parseInt(found[1].replace(/:$/, '')) - 1 : 0;
    let region;
  ...
  async _osdInit() {
    ...
    this._viewer.addHandler('viewport-change', lodash_debounce(() => {
  ...
  static get watchers() { return {
    ...
    "annoBase": ["annoBaseChanged"],
    "_annoTarget": ["_annoTargetChanged"],
    "user": ["userChanged"],
    "_images": ["_imagesChanged"],
    "_selectedIdx": ["_selectedIdxChanged"],
    "_current": ["_currentChanged"],
    "_annotations": ["_annotationsChanged"]
  }; }
};
...
var button_group_styles_default = chunk_GP3HCHHG.r`
  ${chunk_GP3HCHHG.component_styles_default}
...
var SlButtonGroup = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    this.label = "";
  }
...
SlButtonGroup = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-button-group")
], SlButtonGroup);
...
var menu_item_styles_default = chunk_GP3HCHHG.r`
  ${chunk_GP3HCHHG.component_styles_default}
  ...
  :host(${chunk_KO3SJXDW.focusVisibleSelector}:not(.sl-focus-invisible):not([aria-disabled='true'])) .menu-item {
    outline: none;
    background-color: var(--sl-color-primary-600);
    color: var(--sl-color-neutral-0);
  }
...
var SlMenuItem = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    this.checked = false;
    this.value = "";
  ...
  getTextLabel() {
    return chunk_3IYPB6RR.getTextContent(this.defaultSlot);
  }
  handleCheckedChange() {
  ...
  handleDefaultSlotChange() {
    ...
    if (textLabel !== this.cachedTextLabel) {
      this.cachedTextLabel = textLabel;
      chunk_GP3HCHHG.emit(this, "sl-label-change");
    }
  }
  render() {
    return chunk_GP3HCHHG.$`
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2("slot:not([name])")
], SlMenuItem.prototype, "defaultSlot", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".menu-item")
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.watch("checked")
], SlMenuItem.prototype, "handleCheckedChange", 1);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.watch("disabled")
], SlMenuItem.prototype, "handleDisabledChange", 1);
SlMenuItem = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-menu-item")
], SlMenuItem);
...
exports.ve_contact = Header$1;
exports.ve_footer = Footer;
exports.ve_header = Header;
