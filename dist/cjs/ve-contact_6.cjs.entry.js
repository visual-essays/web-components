...
const Header = class {
  ...
  render() {
    return [
      index.h("section", { class: "ve-header" }, index.h("div", { class: "title-panel" }, this.navItems.length > 0 &&
        index.h("nav", null, index.h("sl-dropdown", null, index.h("sl-button", { id: "menu-toggle", slot: "trigger", variant: "default", size: "medium", circle: true }, index.h("sl-icon", { name: "three-dots-vertical", label: "Navigation Meno" })), index.h("sl-menu", null, this.navItems.map((item) => index.h("sl-menu-item", { onClick: this.menuItemSelected.bind(this, item) }, index.h("sl-icon", { slot: "prefix", name: this.navIcon(item), label: item.label }), item.label))))), index.h("a", { href: "/" }, index.h("div", { class: "title" }, this.label)), index.h("div", { class: "subtitle" }, this.subtitle), index.h("div", { id: "image-info-popup" }), index.h("div", { class: "title-buttons" }, index.h("ve-search", { cx: '0a5115e988de8e8a9', filters: '16c:16c,17c:17c,18c:18c,19c:19c,20c:20c,21c:21c,austen:Jane Austen,canterbury:Canterbury,churches:Churches,dickens:Dickens', icon: true, tooltip: "Click to search the site" }), index.h("sl-button", { id: "info-button", onClick: this._showInfoPopup.bind(this), title: "Image info" }, index.h("sl-icon", { name: "info" }))))),
      index.h("ve-contact", { contact: this.contact })
    ];
  }
  get el() { return index.getElement(this); }
