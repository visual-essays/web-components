...
var SlAlert = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    this.hasSlotController = new chunk_GP3HCHHG.HasSlotController(this, "icon", "suffix");
...
var button_styles_default = chunk_GP3HCHHG.r`
  ${chunk_GP3HCHHG.component_styles_default}
...
var FormSubmitController = class {
  constructor(host, options) {
    ...
    this.options = chunk_GP3HCHHG.__spreadValues({
...
var SlButton = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    ...
    this.hasSlotController = new chunk_GP3HCHHG.HasSlotController(this, "[default]", "prefix", "suffix");
    this.localize = new LocalizeController2(this);
    this.hasFocus = false;
  ...
  render() {
    ...
    return n$1`
      ...
      "button--has-suffix": this.hasSlotController.test("suffix")
        ...
        ?disabled=${chunk_GP3HCHHG.l(isLink ? void 0 : this.disabled)}
        type=${chunk_GP3HCHHG.l(isLink ? void 0 : this.type)}
        name=${chunk_GP3HCHHG.l(isLink ? void 0 : this.name)}
        value=${chunk_GP3HCHHG.l(isLink ? void 0 : this.value)}
        href=${chunk_GP3HCHHG.l(isLink ? this.href : void 0)}
        target=${chunk_GP3HCHHG.l(isLink ? this.target : void 0)}
        download=${chunk_GP3HCHHG.l(isLink ? this.download : void 0)}
        rel=${chunk_GP3HCHHG.l(isLink && this.target ? "noreferrer noopener" : void 0)}
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.e({ attribute: "formaction" })
], SlButton.prototype, "formAction", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.e({ attribute: "formmethod" })
], SlButton.prototype, "formMethod", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.e({ attribute: "formnovalidate", type: Boolean })
], SlButton.prototype, "formNoValidate", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.e({ attribute: "formtarget" })
], SlButton.prototype, "formTarget", 2);
SlButton = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-button")
], SlButton);

// src/components/spinner/spinner.styles.ts
var spinner_styles_default = chunk_GP3HCHHG.r`
  ${chunk_GP3HCHHG.component_styles_default}
...
var SlSpinner = class extends chunk_GP3HCHHG.s4 {
  render() {
    return chunk_GP3HCHHG.$`
...
SlSpinner = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-spinner")
], SlSpinner);
...
var dialog_styles_default = chunk_GP3HCHHG.r`
  ${chunk_GP3HCHHG.component_styles_default}
...
var SlDialog = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    this.hasSlotController = new chunk_GP3HCHHG.HasSlotController(this, "footer");
    this.localize = new LocalizeController2(this);
    this.open = false;
    this.label = "";
    this.noHeader = false;
...
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".dialog")
], SlDialog.prototype, "dialog", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".dialog__panel")
], SlDialog.prototype, "panel", 2);
chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.i2(".dialog__overlay")
...
SlDialog = chunk_GP3HCHHG.__decorateClass([
  chunk_GP3HCHHG.n("sl-dialog")
], SlDialog);
...
var l$1 = chunk_GP3HCHHG.e$1(class extends chunk_GP3HCHHG.i {
  constructor(r2) {
    if (super(r2), r2.type !== chunk_GP3HCHHG.t$1.PROPERTY && r2.type !== chunk_GP3HCHHG.t$1.ATTRIBUTE && r2.type !== chunk_GP3HCHHG.t$1.BOOLEAN_ATTRIBUTE)
  ...
  update(i3, [t2]) {
    ...
    if (i3.type === chunk_GP3HCHHG.t$1.PROPERTY) {
      if (t2 === o[l2])
        return chunk_GP3HCHHG.b;
    } else if (i3.type === chunk_GP3HCHHG.t$1.BOOLEAN_ATTRIBUTE) {
      if (!!t2 === o.hasAttribute(l2))
        return chunk_GP3HCHHG.b;
    } else if (i3.type === chunk_GP3HCHHG.t$1.ATTRIBUTE && o.getAttribute(l2) === t2 + "")
      return chunk_GP3HCHHG.b;
    return s$1(i3), t2;
  }
});
...
var SlInput = class extends chunk_GP3HCHHG.s4 {
  constructor() {
    super(...arguments);
    this.formSubmitController = new FormSubmitController(this);
    this.hasSlotController = new chunk_GP3HCHHG.HasSlotController(this, "help-text", "label");
    this.localize = new LocalizeController2(this);
    this.hasFocus = false;
...
var SlMenu = class extends chunk_GP3HCHHG.s4 {
  ...
  typeToSelect(event) {
    ...
    for (const item of items) {
      ...
      const label = chunk_GP3HCHHG.getTextContent(slot).toLowerCase().trim();
...
// setBasePath('https://visual-essays.github.io/web-components/www')
chunk_GP3HCHHG.setBasePath('/web-components');
const navIcons = {
  home: 'house-fill',
...
var SlMenuItem = class extends chunk_GP3HCHHG.s4 {
  ...
  getTextLabel() {
    return chunk_GP3HCHHG.getTextContent(this.defaultSlot);
  }
  handleCheckedChange() {
