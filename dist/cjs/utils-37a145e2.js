...
var sha256$1 = openseadragon.createCommonjsModule(function (module) {
/**
...
(function () {
  ...
  if (NODE_JS) {
    root = openseadragon.commonjsGlobal;
  } else if (WEB_WORKER) {
    root = self;
  }
...
var md5$1 = openseadragon.createCommonjsModule(function (module) {
/**
...
function parseRegionString(region, viewer) {
  ...
  if (ints.length === 4) {
    if (s1.length === 1 || (s1.length === 2 && (s1[0] === 'px' || s1[0] === 'pixel'))) {
      return viewer.viewport.imageToViewportRectangle(new openseadragon.openseadragon.Rect(...ints));
    }
...
exports.getDepictedEntities = getDepictedEntities;
...
exports.parseRegionString = parseRegionString;
