...
var s = class {
  constructor(t3, n5) {
    if (this._$cssResult$ = true, n5 !== e$1)
      throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
    this.cssText = t3;
  }
  get styleSheet() {
    let e4 = n$1.get(this.cssText);
    return t$1 && e4 === void 0 && (n$1.set(this.cssText, e4 = new CSSStyleSheet()), e4.replaceSync(this.cssText)), e4;
  }
  toString() {
    return this.cssText;
  }
};
var o$2 = (t3) => new s(typeof t3 == "string" ? t3 : t3 + "", e$1);
var r = (t3, ...n5) => {
...
var i$1 = (e4, n5) => {
  t$1 ? e4.adoptedStyleSheets = n5.map((t3) => t3 instanceof CSSStyleSheet ? t3 : t3.styleSheet) : n5.forEach((t3) => {
...
var S = t$1 ? (t3) => t3 : (t3) => t3 instanceof CSSStyleSheet ? ((t4) => {
  let e4 = "";
...
var a = class extends HTMLElement {
  ...
  createRenderRoot() {
    ...
    return i$1(s5, this.constructor.elementStyles), s5;
  }
  connectedCallback() {
    var t3;
...
exports.b = b;
exports.component_styles_default = component_styles_default;
exports.e = e;
exports.e$1 = e$2;
exports.emit = emit;
